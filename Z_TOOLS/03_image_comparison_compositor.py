...
a UI for comparing and compositing original Marvel Heroes Omega art assets with altered versions.
a canvas to arrange the images in rows to group for visualization, Images are matched by filename stem.
...
CONFIG_FILE = "03_image_comparison_compositor_config.json"

# endregion
# region Config persistence helpers
...
# endregion
# region Triplet matching and composite creation
...
# endregion
# region UI - CompositeArrangementUI
...
class CompositeArrangementUI:
    ...
    # endregion
    # region Layout and file handling
    ...
    # endregion
    # region Composite generation and config
